    ...
    groups: [
      {
        items: [
          ...
          `Or: Would you like to hear what’s worked for other clients dealing with these issues?`,
          `You’re not alone in that aspect`,
          `That’s a barrier for a lot of people`,
          `Working with clients in your situation, they will…`,
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          `A lot of clients start out where you are.`,
